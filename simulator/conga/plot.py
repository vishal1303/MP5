...
plot_line_graph(load_path,Keys,["results_heavytail_1.dat","results_heavytail_0.dat","prototype.dat"],"conga","Normalized Throughput",xaxis="Number of Pipelines", xtransform=None)
