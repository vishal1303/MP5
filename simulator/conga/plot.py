...
plot_line_graph(load_path,Keys,["results_uniform_1.dat","results_uniform_0.dat","prototype.dat"],"conga","Normalized Throughput",xaxis="Number of Pipelines", xtransform=None)
