...
plot_line_graph(load_path,Keys,["results_uniform_1.dat","results_heavytail_1.dat","results_uniform_0.dat","results_heavytail_0.dat"],"packet-size","Normalized Throughput",xaxis="Packet Size (Bytes)", xtransform=None)
